...
Much in line with what rational voices have been saying for the better part of a year, whether or not counties or states mandate masks at different times, for different periods of time, or mandate them at all has no bearing on the path the virus takes. If lack of compliance nullifies the effectiveness of mask mandates, why not remove the mandates and simply trust the voluntary decisions of individuals? Either that or the state ought to assign each household, street corner, and place of business an officer, or officers, to monitor and enforce total mask compliance on a 24/7 basis.

However, proponents of mask mandates have to believe that the mandates are better than nothing and would, on average, create enough social pressure to induce at least *some* increased compliance with mask-wearing. If that's the case, how do proponents of mask mandates explain the population-adjusted comparisons of counties within the same state that show counties without mask mandates following the same case patterns and often achieving better results than counties with mask mandates? This comparison is impossible to justify if mask mandates induce *any* level of increased compliance.
